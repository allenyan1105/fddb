...
# where the binary is
my $evaluateBin = "/home/ubnt/datasets/fddb/evaluation/evaluate"; 
# where the images are
my $imDir = "/home/ubnt/datasets/fddb/FDDB/images"; 
# where the folds are
my $fddbDir = "/home/ubnt/datasets/fddb/FDDB-folds"; 
# where the detections are
my $detDir = "/home/ubnt/datasets/fddb/FDDB-folds"; 
###########################
...
system($evaluateBin, "-a", $annotFile, "-d", "./output.txt", "-f", $detFormat, "-i", $imDir, "-l", $listFile, "-r", $detDir);
